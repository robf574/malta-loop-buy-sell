...
export const VallettaBackground: React.FC = () => {
  return (
    <div className="absolute inset-0 bg-gradient-to-b from-orange-200 via-amber-100 to-orange-100">
      {/* Warm sky with realistic clouds */}
      <div className="absolute inset-0 bg-gradient-to-b from-amber-100 via-orange-50 to-yellow-100"></div>
        ...
        <div className="absolute bottom-0 left-0 w-full h-full">
          ...
          <div className="absolute bottom-2/3 left-0 w-full h-1/3 bg-gradient-to-t from-amber-600 via-amber-500 to-amber-400">
            ...
            <div className="absolute bottom-0 left-1/3 w-1/6 h-full">
              ...
              <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 w-8 h-8 bg-gradient-to-b from-amber-400 to-amber-600 rounded-full shadow-lg"></div>
            ...
            <div className="absolute bottom-0 right-1/3 w-1/12 h-full">
              ...
              <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 w-3 h-12 bg-gradient-to-b from-amber-300 to-amber-500 rounded-t-full shadow-lg"></div>
      ...
      {/* Mediterranean Sea */}
      <div className="absolute bottom-0 left-0 w-full h-1/4 bg-gradient-to-t from-teal-700 via-teal-500 to-teal-400">
        {/* Realistic wave patterns */}
        <div className="absolute bottom-0 left-0 w-full h-3 bg-gradient-to-t from-teal-800 to-teal-600 rounded-t-full"></div>
        <div className="absolute bottom-2 left-0 w-full h-2 bg-gradient-to-t from-teal-700 to-teal-500 rounded-t-full"></div>
        <div className="absolute bottom-4 left-0 w-full h-1 bg-gradient-to-t from-teal-600 to-teal-400 rounded-t-full"></div>
        
        {/* Sailboat in foreground */}
        <div className="absolute bottom-8 left-1/3 w-8 h-6 bg-gradient-to-b from-white to-teal-100 rounded-t-lg shadow-lg">
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-1 h-8 bg-amber-600"></div>
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-6 h-4 bg-gradient-to-r from-white to-teal-50 rounded-sm"></div>
        </div>
        
        {/* Additional small boats */}
        <div className="absolute bottom-6 right-1/4 w-4 h-3 bg-gradient-to-b from-white to-teal-100 rounded-t-md shadow-md">
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-0.5 h-4 bg-amber-600"></div>
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-3 h-2 bg-gradient-to-r from-white to-teal-50 rounded-sm"></div>
        </div>
      </div>
    </div>
  );
